...
urlpatterns = [
    ...
    path("posts/<int:ticket_id>/add_review", critics.views.add_review, name="add_review"),
    path("review/<int:review_id>/modify", critics.views.modify_review, name="modify_review"),
    path("review/<int:review_id>/delete", critics.views.delete_review, name="delete_review"),
